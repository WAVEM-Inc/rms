...
TASK_CONTROLLER_NODE_NAME: str = "ktp_task_controller";

ASSIGN_MISSION_SERVICE_NAME: str = f"/{TASK_CONTROLLER_NODE_NAME}/assign/mission";
...
ASSIGN_CONTROL_SERVICE_NAME: str = f"/{TASK_CONTROLLER_NODE_NAME}/assign/control";
...
CONVERT_TASK_TO_PATH_SERVICE_NAME: str = f"/{NODE_NAME}/path/convert";
LOOK_UP_PATH_SERVICE_NAME: str =  f"/{NODE_NAME}/path/look_up";
