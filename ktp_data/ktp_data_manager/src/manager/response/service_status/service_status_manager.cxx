...
void ktp::data::ServiceStatusManager::mission_status_from_task_ctrl_subscription_cb(const ktp_data_msgs::msg::ServiceStatus::SharedPtr mission_status_cb)
{
    ...
    // service_status->set__mission_code(mission_status_cb->mission_code);
    // service_status->set__mission_id(mission_status_cb->mission_id);
    // service_status->set__owner(mission_status_cb->owner);
    ...
    // const std::vector<ktp_data_msgs::msg::MissionTask> &mission_task_vec = mission_status_cb->task;
