    ...
    : node_(node)
{
    ...
    this->notify_mission_report_from_task_ctrl_subscription_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
...
void ktp::data::ControlReportManager::notify_mission_report_from_task_ctrl_subscription_cb(const ktp_data_msgs::msg::ControlReport::SharedPtr notify_mission_cb)
{
