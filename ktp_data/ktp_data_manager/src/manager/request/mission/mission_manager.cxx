    ...
    : node_(node)
{
    ...
    this->assign_mission_publisher_cb_group_ = this->node_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
    rclcpp::PublisherOptions assign_mission_publisher_opts;
    assign_mission_publisher_opts.callback_group = this->assign_mission_publisher_cb_group_;
    this->assign_mission_publisher_ = this->node_->create_publisher<ktp_data_msgs::msg::Mission>(
        "/rms/ktp/data/assign/mission",
        rclcpp::QoS(1),
        assign_mission_publisher_opts);
    ...
    const std::shared_ptr<ktp_data_msgs::srv::AssignMission::Response> response)
{
    ...
    this->assign_mission_publish(mission_request_from_itf);
...
void ktp::data::MissionManager::assign_mission_publish(ktp_data_msgs::msg::Mission mission)
{
    this->assign_mission_publisher_->publish(mission);
}
